...
import com.hhly.smartdata.service.smartdata.IntervalCompositeService;
...
public class IntervalCompositeControllerApi extends BaseController{
    ...
    public Result getChart(String startDate, String endDate, String deviceTypes){
        Map<String, Object> result = null;
        try{
            TreeSet<String> scales = HourListUtil.getHourListPerHour();
            result = intervalSourceService.selectIntervalSourceChartData(startDate, endDate, deviceTypes, scales);
        }catch(Exception e){
