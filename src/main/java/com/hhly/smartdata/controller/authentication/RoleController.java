...
public FunctionService  functionService ;
    ...
    @RequiresPermissions("sys_role_update")
    public @ResponseBody List<Node> edittree(HttpServletRequest request ,HttpServletResponse response){
        User  user=(User)request.getSession().getAttribute(SysConstant.SESSION_USER);
...
/*
    ...
    public @ResponseBody boolean validateRoleName(HttpServletRequest req,HttpServletResponse resp){
