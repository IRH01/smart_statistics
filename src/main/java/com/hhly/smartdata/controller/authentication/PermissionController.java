...
public class PermissionController {
    ...
    public @ResponseBody List<Permission> searchPerms(@ModelAttribute Permission condition,HttpServletRequest req){
    ...
    public @ResponseBody String updatePerms(@RequestParam Integer funcId,@RequestParam String permsJson) {
