...
public class MenuController {
    ...
    public @ResponseBody String menuListByRole(HttpServletRequest req){
    ...
    public @ResponseBody Map<String,Integer> sort(@RequestParam String menuTree){
    ...
    public @ResponseBody String update(@ModelAttribute Menu menu){
    ...
    @RequiresPermissions("sys_menu_list")
    public @ResponseBody Menu menuDetail(@RequestParam Integer id){
