 ...
 */
@Controller
@RequestMapping(value = "/partner/cmsmreport")
public class CommissionsMReportController{
    private static Logger logger = Logger.getLogger(CommissionsMReportController.class.getName());
    ...
    public ModelAndView show(String userId, ModelMap modelMap){
        ...
        view.setViewName("operative/partner/cmsmreport/show");
        return view;
    }
