												...
												<table class="tableListGame">
													<thead>
														<tr>
															...
															<th style="min-width:50px;">充值金额(MYR)<img class="order dailyDataOrder" src="${path}/img/arrow_disable.png" onclick="dailyOrderChange(this);" order=0 name="pay_amount"/></th>
		...
		<script type="text/javascript">
			...
			var showGameData = function(dailyDataEle){
				...
				var columnHeader = getColumnHead(1,"游戏ID","game_id","gameDataOrder","gameOrderChange")
							     ...
							     + getColumnHead(0,"充值金额(MYR)","pay_amount","gameDataOrder","gameOrderChange")
			...
			var showChannelData = function(gameDataEle){
				...
				var columnHeader = getColumnHead(2,"渠道ID","channel_id","channelDataOrder","channelOrderChange")
			     ...
			     + getColumnHead(0,"充值金额(MYR)","pay_amount","channelDataOrder","channelOrderChange")
