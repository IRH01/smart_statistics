									    ...
									    <div class="select-fr" style="padding-right: 30px;float:left;">
									    	<table style="margin-left:5px;">
									    		<tr>
									    			...
									    			<td colspan="3"><input id="email" class="input" style="width: 165px;"></td>
									    		...
									    		<tr>
									    			...
									    			<td><span class="span"><input id="amountStart" style="width:80px;" class="input-amount" onKeypress="return numberInput(event);" onkeyup="value=numberCheck(value);" onblur="value=checkAmount(true);"></td>
									    			<td>-</td>
									    			<td><input id="amountEnd" style="width:80px;" onKeypress="return numberInput(event);" onkeyup="value=numberCheck(value);" class="input-amount" onblur="value=checkAmount(false);"></span></td>
															...
															<table class="tableList1">
																<thead>
																	<tr>
																		...
																		<th>充值金额（VND）<img id='amountOrder' class='order' src='${path}/img/arrow_down.png' onclick='orderchange(this);' lang='1'></img></th>
																	</tr>
																</thead>
																<tbody id="data">
																</tbody>
		...
		<script type="text/javascript">
			...
			var addTbRow = function(data){
				if(null != data && undefined != data && "" != data){
					var ele="<tr><td>channelId</td><td>channelName</td><td>userId</td><td>nickName</td><td>platformName</td><td>serverName</td><td>phone</td><td>email</td><td>regTime</td><td>totalAmount</td></tr>";
					ele = ele.replace("channelId",data.channelId).replace("channelName",data.channelName).replace("userId",data.userId).replace("nickName",data.nickName).replace("platformName",data.platformName).replace("serverName",data.serverName).replace("phone",data.phone).replace("email",data.email).replace("regTime",data.regTime).replace("totalAmount",data.totalAmount);
					$("#data").append(ele);
				}
			}
