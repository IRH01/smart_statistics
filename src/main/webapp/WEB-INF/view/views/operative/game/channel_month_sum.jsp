			...
			<div class="panel-heading" role="tab" id="headingchannelName">
				<h4 class="panel-title" id="-collapsible-group-item-#1-">
					<a data-toggle="collapse" data-parent="#accordion"
						...
						aria-controls="collapsechannelName" class=""> 渠道充值消费汇总报表 </a>
				</h4>
			</div>
...
<script type="text/javascript">
			...
			var addTbRow = function(data,isTotalRow){
				if(null != data && undefined != data && "" != data){
					var ele="<tr><td><a href='${path}/game/lawyerUserStatistics/showDay.do?rechargeMonth=" + data.rechargeMonth + "&channelId=" + data.channelId + "'> " + data.rechargeMonth + "</a></td><td>" + data.channelId + "</td><td>" + data.registUsers + "</td><td>" + data.actionUsers + "</td><td>" + data.rechargeUsers + "</td><td>" + data.rechargeAmount + "</td><td>" + data.dzBetingUsers + "</td><td>" + data.dzBetingAccSum + "</td><td>" + data.djBetingUsers + "</td><td>" + data.djBetingAccSum + "</td>";
					$("#data").append(ele);
				}
			}
			...
			var showData = function(pageNumber,pageSize){
				$("#data").empty();
				$.post("${path}/game/lawyerUserStatistics/listMonth.do",{
			...
			var exportToExcel = function(){
				...
				$.ajax({
				    url: "${path}/game/lawyerUserStatistics/exportMonth.do",
				    type: "POST",
				    data: {
				    	rechargeMonth:$("#rechargeMonth").val(),
						channelId:$("#channelId").val()
				    ...
				    success:function(response, status, request){
				        ...
				        window.location = "${path}/game/lawyerUserStatistics/downloadMonth.do?uuid=" + response.uuid;
			    }});
			}
