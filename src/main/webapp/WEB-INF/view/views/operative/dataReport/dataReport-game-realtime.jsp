...
<script type="text/javascript">
			...
			var addTbRow = function(data,isTotalRow){
				if(null != data && undefined != data && "" != data){
					...
					var ele = "<tr><td>" + data.gameName
								+ "</td><td>" + data.gameRechargeAmount + "</td><td>"
								+ data.lybRechargeAmount + "</td><td>" + data.remitAmount
								+ "</td><td>" + data.rechargeUcnt + "</td><td>"
								+ data.rechargeCnt + "</td><td>" + data.totalRechargeAmount
								+ "</td><td>" + data.gameDau
								+ "</td><td>" + data.regUcnt
								+ "</td>";
	...
	var showData = function(pageNumber, pageSize) {
		...
		$
				.post(
						"${path}/dataReport/game/realtime/list.do",
						{
								...
								if (null == infoData || undefined == infoData
									...
									for (var i = 0; i < infoData.length; i++) {
										var ele = {
											...
											remitAmount : infoData[i].remitAmount,
