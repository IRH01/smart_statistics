...
<script type="text/javascript">
			...
			var addTbRow = function(data,isTotalRow){
				if(null != data && undefined != data && "" != data){
					var ele="<tr><td><a href='${path}/dataReport/game/day/showList.do?gameName=" + encodeURI(encodeURI(data.gameName)) + "&dateStart=" + $("#dateStart").val() + "&dateEnd=" + $("#dateEnd").val() + "'> " + data.gameName + "</a><td>" + data.gameRecharge + "</td><td>" + data.lybRecharge + "</td><td>" + data.yxExchange + "</td><td>" + data.allRecharge + "</td><td>" + data.rechargePeople + "</td><td>" + data.rechargeTimes + "</td><td>" + data.newRegister + "</td>";
					$("#data").append(ele);
				}
			}
			...
			var showData = function(pageNumber,pageSize){
				$("#data").empty();
				$.post("${path}/dataReport/game/day/list.do",{
