...
<script type="text/javascript">
			...
			var addTbRow = function(data,isTotalRow){
				if(null != data && undefined != data && "" != data){
					var ele="<tr><td>" + data.orderNo + "</td><td>" + data.userId + "</td><td>" + data.nickName + "</td><td>" + data.handleTime + "</td><td>" + data.rechargeType + "</td><td>" + data.beforeCash + "</td><td>" + data.lyb + "</td><td>" + data.afterCash + "</td>";
					$("#data").append(ele);
				}
			}
			...
			var showData = function(pageNumber,pageSize){
				$("#data").empty();
				$.post("${path}/debit/consumer/list.do",{
					userId:$("#userId").val(),
						...
						if(null == infoData || undefined == infoData || 0 >= infoData.length){
							...
							for(var i=0;i < infoData.length;i++){
								...
								var ele = {
										...
										beforeCash:infoData[i].beforeCash,
										lyb:infoData[i].lyb,
										afterCash:infoData[i].afterCash
								}
								addTbRow(ele);
							}
						}
			...
			var exportToExcel = function(){
				...
				$.ajax({
				    url: "${path}/debit/consumer/export.do",
				    type: "POST",
				    data: {
				    	userId:$("#userId").val(),
						nickName:$("#nickName").val(),
				    ...
				    success:function(response, status, request){
				        ...
				        window.location = "${path}/debit/consumer/download.do?uuid=" + response.uuid;
			    }});
			}
