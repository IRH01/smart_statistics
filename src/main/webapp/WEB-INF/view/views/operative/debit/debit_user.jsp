...
<script type="text/javascript">
			...
			var addTbRow = function(data,isTotalRow){
				if(null != data && undefined != data && "" != data){
					var ele="<tr><td>" + data.userId + "</td><td>" + data.nickName + "</td><td>" + data.lybCnt + "</td><td>" + data.lyqCnt + "</td><td>" + data.djbCnt + "</td><td>" + data.dzbCnt + "</td>";
					$("#data").append(ele);
				}
			}
						...
						if(null == infoData || undefined == infoData || 0 >= infoData.length){
							...
							for(var i=0;i < infoData.length;i++){
								...
								var ele = {
										...
										lybCnt:infoData[i].lybCnt,
										lyqCnt:infoData[i].lyqCnt,
										djbCnt:infoData[i].djbCnt,
										dzbCnt:infoData[i].dzbCnt
								}
								addTbRow(ele);
							}
						}
			...
			var exportToExcel = function(){
				...
				$.ajax({
				    ...
				    success:function(response, status, request){
				        ...
				        window.location = "${path}/debit/user/download.do?uuid=" + response.uuid;
			    }});
			}
