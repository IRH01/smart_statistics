									    ...
									    <div class="select-fr" style="padding-right: 30px;float:left;">
									    	<table style="margin-left:5px;">
									    		<tr>
									    			...
									    			<td class="tb1Td"><span class="span">兑换来源：</span></td>
...
<script type="text/javascript">
			...
			var addTbRow = function(data,isTotalRow){
				if(null != data && undefined != data && "" != data){
					var ele="<tr><td>" + data.orderId + "</td><td>" + data.userId + "</td><td>" + data.nickName + "</td><td>" + data.exchangeStatus + "</td><td>" + data.exchangeGame + "</td><td>" + data.exchangeAmout + "</td><td>" + data.commitTime + "</td><td>" + data.tradeTime + "</td>";
					$("#data").append(ele);
				}
			}
			...
			var showData = function(pageNumber,pageSize){
				$("#data").empty();
				$.post("${path}/debit/exchange/list.do",{
					orderId:$("#orderId").val(),
					userId:$("#userId").val(),
						...
						if(null == infoData || undefined == infoData || 0 >= infoData.length){
							...
							for(var i=0;i < infoData.length;i++){
								...
								var ele = {
										...
										exchangeAmout:infoData[i].exchangeAmout,
			...
			var exportToExcel = function(){
				...
				$.ajax({
				    url: "${path}/debit/exchange/export.do",
				    type: "POST",
				    data: {
				    	orderId:$("#orderId").val(),
						userId:$("#userId").val(),
				    ...
				    success:function(response, status, request){
				        ...
				        window.location = "${path}/debit/exchange/download.do?uuid=" + response.uuid;
			    }});
			}
