                                                    ...
                                                    <div class="tablePanel">
                                                        <table class="tableListGame">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="min-width:100px;">PC-新用户充值</th>
                                                                <th style="min-width:100px;">PC-老用户充值</th>
                                                                <th style="min-width:70px;">PC-ARPU</th>
                                                                <th style="min-width:140px;">android-充值人数</th>
                                                                <th style="min-width:140px;">android-充值金额</th>
                                                                <th style="min-width:140px;">android-充值次数</th>
                                                                <th style="min-width:140px;">android-新用户充值</th>
                                                                <th style="min-width:140px;">android-老用户充值</th>
                                                                <th style="min-width:140px;">android-ARPU</th>
                                                                <th style="min-width:100px;">IOS-充值人数</th>
                                                                <th style="min-width:100px;">IOS-充值金额</th>
                                                                <th style="min-width:100px;">IOS-充值次数</th>
                                                                <th style="min-width:130px;">IOS-新用户充值</th>
                                                                <th style="min-width:130px;">IOS-老用户充值</th>
                                                                <th style="min-width:100px;">IOS-ARPU</th>
                                                                <th style="min-width:100px;">H5-充值人数</th>
                                                                <th style="min-width:100px;">H5-充值金额</th>
                                                                <th style="min-width:100px;">H5-充值次数</th>
                                                                <th style="min-width:130px;">H5-新用户充值</th>
                                                                <th style="min-width:130px;">H5-老用户充值</th>
