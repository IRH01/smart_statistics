...
<%@ attribute name="page1" type="com.hhly.util.page.Page"
	required="true"%>
...
<div class="page-pull-right">
	...
	<%} %>
	<input type="text" id="pageToGo" style="width:30px;" onkeypress="return (/[\d]/.test(String.fromCharCode(event.charCode)));" onkeyup="value=numberCheck(value);">
